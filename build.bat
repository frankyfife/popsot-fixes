...
cl /nologo /O2 /MT /LD /EHsc /W3 /Fo:build\ src\proxy.cpp src\menupad.cpp src\trace.cpp src\consolemenu.cpp src\gamepad.cpp /Fe:build\dx.dll /link /DEF:src\dx.def user32.lib
